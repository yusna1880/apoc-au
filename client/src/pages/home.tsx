...
export default function Home() {
  ...
  const story: DialogueLine[] = useMemo(() => [
    ...
    { speaker: "렌쟈", text: "\"알아. 위험한 거.\"", background: bgLivingRoom2, character: "렌쟈" },
    { speaker: "란", text: "\"그럼에도 가시겠다면 저는 따르겠습니다.\"", background: bgLivingRoom2, character: "란" },
    { speaker: "시스템", text: "렌쟈는 그 말에 잠깐 숨을 고른다.", background: bgLivingRoom2, isProgress: true },
    { speaker: "하카", text: "\"이야. 충성심 미쳤네.\"", background: bgLivingRoom2, character: "하카" },
    { speaker: "란", text: "\"선택입니다.\"", background: bgLivingRoom2, character: "란" },
    { speaker: "데일", text: "\"…난 아직 이 새끼 안 믿어.\"", background: bgLivingRoom2, character: "데일" },
    { speaker: "신라", text: "\"당연합니다.\"", background: bgLivingRoom2, character: "신라" },
    { speaker: "데일", text: "\"그래도 엘 돌아올 가능성 있다면—\"", background: bgLivingRoom2, character: "데일" },
    { speaker: "시스템", text: "말을 멈춘다.", background: bgLivingRoom2, isProgress: true },
    { speaker: "데일", text: "\"…젠장.\"", background: bgLivingRoom2, character: "데일" },
    { speaker: "시스템", text: "렌쟈가 신라를 본다.", background: bgLivingRoom2, isProgress: true },
    { speaker: "렌쟈", text: "\"하지만 넌 더 이상 여기 있을 수 없어.\"", background: bgLivingRoom2, character: "렌쟈" },
    { speaker: "신라", text: "\"…네.\"", background: bgLivingRoom2, character: "신라" },
    { speaker: "데일", text: "\"제대로 처리해.\"", background: bgLivingRoom2, character: "데일" },
    { speaker: "하카", text: "\"누가보면 애 죽이는 줄 알겠네.\"", background: bgLivingRoom2, character: "하카" },
    { speaker: "시스템", text: "신라는 하카의 거대한 몸집에 쫓기듯이 나온다.", background: bgLivingRoom2, isProgress: true },
    { speaker: "시스템", text: "엘의 숨소리가 아주 미세하게 바뀐다.", background: bgLivingRoom2, isProgress: true },
